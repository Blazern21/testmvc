...
import 'package:testmvcdio/controller/complete_profile_controller.dart';
import 'package:testmvcdio/models/complete_profile_model.dart';
import 'package:testmvcdio/views/complete_profile_view.dart';
...
import '../views/age_select_view.dart';
import '../controller/genre_select_controller.dart';
import '../models/genre_select_model.dart';
import '../styles/button2.dart';
import '../styles/buttonSelected.dart';

class GenreSelectView extends StatefulWidget {
  final GenreSelectController controller;
  final GenreSelectModel model;

  GenreSelectView(this.controller, this.model);

  @override
  State createState() => GenreSelectViewState();
}

class GenreSelectViewState extends State<GenreSelectView> {
                      ...
                      children: [
                        ...
                        TextButton(
                          onPressed: () => Navigator.of(context)
                              .push(MaterialPageRoute(builder: (_) => AgeSelectView(AgeSelectController(AgeSelectModel()) , AgeSelectModel()))),
                              ...
                              children: [
                                ElevatedButton(
                                  ...
                                  onPressed: () => Navigator.of(context).push(
                                      MaterialPageRoute(builder: (_) => CompleteProfileView())),
